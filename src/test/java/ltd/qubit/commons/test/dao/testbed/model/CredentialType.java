...
public enum CredentialType implements LocalizedEnum {
  ...
  public static CredentialType forName(final String name) {
    return forName(Locale.getDefault(), name);
  }

  public static CredentialType forName(final Locale locale, final String name) {
